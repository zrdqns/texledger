  ...
  return (
    <form action={action} className="flex w-full flex-col gap-5">
      ...
      <button
        type="submit"
        disabled={pending}
        className="group mt-1 flex items-center justify-center gap-2 rounded-lg bg-primario py-2.5 text-sm font-semibold text-fondo shadow-[0_0_20px_rgba(91,124,250,0.4)] transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:brightness-110 active:scale-[0.98] disabled:opacity-50"
      >
